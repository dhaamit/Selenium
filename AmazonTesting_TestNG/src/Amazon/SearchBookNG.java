...
public class SearchBookNG {
	...
	public void searchBook() {
		...
		explicitWait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@class='acswidget-carousel__title']")));
	...
	@Test
	public void validateBookSeller() {
		if (booksBestSeller.contains("Best sellers in Books")) {
			System.out.println("Book Search Success.");
			Assert.assertTrue(true);
		} else {
			System.out.println("Book Search Failed.");
