...
public class HandlingWindows {
	...
	public static void main(String[] args) {
		...
		wwWait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//a[@href='/windows/new']"))));
		...
		wwWait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//h3"))));
